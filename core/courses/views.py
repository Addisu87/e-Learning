...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    def get_form(self, model, *args, **kwargs):
        # Generate a form dynamically for the specified model
    ...
    def post(self, request, module_id, model_name, id=None):
        ...
        if form.is_valid():
            ...
            obj.save()
            if not id:
                # If it's a new content, create a Content object linking to the module
...
class ModuleContentListView(TemplateResponseMixin, View):
    ...
    def get(self, request, module_id):
        # Handle GET request to render the content list
...
class CourseListView(TemplateResponseMixin, View):
    #  the courses list available on the platform for enrolled students
    model = Course
